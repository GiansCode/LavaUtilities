package com.github.lewysdavies.probabilitymap;
...
/**
 * ProbabilityMap to easily handle probability <br><br>
 *
 ...
 * <li>Therefore "boxes" with larger probability have a greater chance of being selected than those with smaller
 *     probability.
 * </p></ul>
 ...
 * @author Lewys Davies
 */
public final class ProbabilityMap<E> {
    private Map<E, Integer> map = new LinkedHashMap<>();
    ...
    public ProbabilityMap(Map<E, Integer> elements) {
        Validate.notNull(elements, "Cannot initialise map with a null elements map. Use default constructor");
     ...
     */
    public void add(E element, int probability) {
        Validate.notNull(element);
        Validate.isTrue(probability > 0, "Probability for an element must be greater than 0");
     ...
     * @param elements
     */
    public void addAll(Map<E, Integer> elements) {
    ...
    public void remove(E element) {
        Validate.notNull(element, "Cannot remove element null");
    ...
    private void updateState() {
        ...
        this.map = this.map.entrySet().stream()
                .sorted(Map.Entry.<E, Integer>comparingByValue().reversed())
